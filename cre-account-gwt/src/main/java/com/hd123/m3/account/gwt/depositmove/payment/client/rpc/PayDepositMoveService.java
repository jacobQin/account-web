 ...
 * 文件名：	PayDepositMoveService.java
 * 模块说明：	
 * 修改历史：
 ...
 * 
 */
@RemoteServiceRelativePath("account/payDepositMove")
public interface PayDepositMoveService extends M3ModuleService, M3ModuleNaviService {
  ...
  public static class Locator {
    private static PayDepositMoveServiceAsync service = null;

    public static PayDepositMoveServiceAsync getService() {
      if (service == null)
        service = GWT.create(PayDepositMoveService.class);
      return service;
    }
  }
