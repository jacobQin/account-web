 ...
 * 
 */
public class PayInvoiceRegLineViewGadget extends RCaptionBox {

  public PayInvoiceRegLineViewGadget() {
    drawSelf();
  }
    ...
    public Object getData(int row, int col) {
      ...
      if (col == lineNumberCol.getIndex()) {
        ...
        if (line.getAcc1().getSourceBill() == null
          ...
          return null;
        BBillType type = EPPayInvoiceReg.getInstance().getBillTypeMap()
