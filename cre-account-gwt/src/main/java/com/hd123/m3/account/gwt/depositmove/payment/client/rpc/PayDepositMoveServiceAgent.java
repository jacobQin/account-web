 ...
 * 文件名：	PayDepositMoveServiceAgent.java
 * 模块说明：	
 * 修改历史：
 ...
 * 
 */
public class PayDepositMoveServiceAgent {
  ...
  public static void executeTask(final BProcessContext processCtx, final BOperation operation,
    ...
    PayDepositMoveService.Locator.getService().executeTask(operation, entity, processCtx.getTask(),
