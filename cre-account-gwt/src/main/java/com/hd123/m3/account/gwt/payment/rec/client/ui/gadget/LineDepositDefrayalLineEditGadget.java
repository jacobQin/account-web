 ...
 * 
 */
public class LineDepositDefrayalLineEditGadget extends Composite implements HasRActionHandlers,
  ...
  private BPaymentLineDeposit value = new BPaymentLineDeposit();
  ...
  public LineDepositDefrayalLineEditGadget() {
    root = new FlexTable();
    ...
    totalField.setMinValue(BigDecimal.ZERO,true);
    ...
    totalField.setValidator(new RValidator() {
      ...
      public Message validate(Widget sender, String value1) {
        if (!(value != null && value.getTotal() != null
            && totalField.getValueAsBigDecimal() != null && (value.getTotal().compareTo(
            totalField.getValueAsBigDecimal()) == 0))) {
          value.setTotal(totalField.getValueAsBigDecimal());
          RActionEvent.fire(LineDepositDefrayalLineEditGadget.this,
              ActionName.ACTION_LINEDEPOSITDEFRAYALLINE_CHANGE);
        }
        if (totalField.getValueAsBigDecimal() != null
            && totalField.getValueAsBigDecimal().compareTo(BigDecimal.ZERO) < 0) {
          ...
          return Message.error(ReceiptMessages.M.cannotMoreThan(
            ...
            && totalField.getValueAsBigDecimal().compareTo(value.getRemainTotal()) > 0) {
          return Message.error(ReceiptMessages.M.cannotMoreThan(
              PPaymentDepositDefrayalDef.constants.total(),
              ReceiptMessages.M.remainTotal() + value.getRemainTotal()));
        } else {
          return null;
        }
      }
    ...
    remarkField = new RTextBox(PPaymentLineDepositDef.remark);
    ...
    addButton = new RToolbarButton(RActionFacade.ADD_ITEM, new ClickHandler() {
      ...
      public void onClick(ClickEvent arg0) {
        ...
        RActionEvent.fire(LineDepositDefrayalLineEditGadget.this,
            ActionName.ACTION_LINEDEPOSITDEFRAYALLINE_ADDDETAIL, value.getItemNo());
      }
    });
    ...
    removeButton = new RToolbarButton(RActionFacade.REMOVE_ITEM, new ClickHandler() {
      ...
      public void onClick(ClickEvent arg0) {
        GWTUtil.blurActiveElement();
        RActionEvent.fire(LineDepositDefrayalLineEditGadget.this,
            ActionName.ACTION_LINEDEPOSITDEFRAYALLINE_REMOVEDETAIL, value.getItemNo());
      }
    });
  ...
  public BPaymentLineDeposit getValue() {
    return value;
  }

  public void setValue(BPaymentLineDeposit value) {
    setValue(value, false);
  }

  public void setValue(BPaymentLineDeposit value, boolean fireEvent) {
    this.value = value;
  ...
  public static class ActionName {
    /** 改变值 */
    public static final String ACTION_LINEDEPOSITDEFRAYALLINE_CHANGE = "LINEDEPOSITDEFRAYALLINE_change";
    /** 增加一行 */
    public static final String ACTION_LINEDEPOSITDEFRAYALLINE_ADDDETAIL = "LINEDEPOSITDEFRAYALLINE_ADD_DETAIL";
    /** 删除一行 */
    public static final String ACTION_LINEDEPOSITDEFRAYALLINE_REMOVEDETAIL = "LINEDEPOSITDEFRAYALLINE_REMOVE_DETAIL";
  }

  @Override
  public Focusable getFocusable(String field) {
    if (BPaymentLineDeposit.FN_LINEDEPOSITTOTAL.equals(field))
      return totalField;
    else if (BPaymentLineDeposit.FN_LINEDEPOSITSUBJECT.equals(field))
      return subjectField;
    return null;
  }
  ...
  public void refreshContracts(List<BUCN> contracts, BPaymentAccountLine line) {
    contractField.refreshOptions(contracts);
    contractField.setValue(line.getAcc1().getContract());
    value.setContract(line.getAcc1().getContract());
