...
public class SubjectBrowserDialog extends RBrowserDialog<BSubject> {
  ...
  public SubjectBrowserDialog(String subjectType, Integer direction, Boolean state, String usageType,boolean multiSelect) {
    ...
    getGrid().setSingleSelection(!multiSelect);
