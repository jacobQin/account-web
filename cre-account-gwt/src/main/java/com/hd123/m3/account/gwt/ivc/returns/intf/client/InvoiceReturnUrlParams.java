 ...
 * 文件名：	InvoiceReturnUrlParams.java
 * 模块说明：	
 * 修改历史：
 * 2015年12月13日 - lixiaohong - 创建。
 */
package com.hd123.m3.account.gwt.ivc.returns.intf.client;
...
/**
 * GWT模块com.hd123.m3.account.gwt.ivc.returns.InvoiceReturn（发票领退单）的URL参数。
 * 
 * @author lixiaohong
 * @since 1.0
 * 
 */
public class InvoiceReturnUrlParams implements ModuleUrlParams{
  public static final String ENTRY_MODULE = "ivc.returns.InvoiceReturn";
  public static final String ENTRY_FILE = "InvoiceReturn.html";
  ...
  public static interface Flecs extends Base {
    /** 搜索条件的分组ID */
    public static final String GROUP_ID = "Ivc.InvoiceReturn";
