 ...
 */
package com.hd123.m3.account.gwt.ivc.transport.intf.client.dd;
 ...
 * 
 */
public class PInvoiceTransportDef {
  public static CPInvoiceTransport constants = (CPInvoiceTransport) GWT
      .create(CPInvoiceTransport.class);
  ...
  public static EmbeddedFieldDef inAccountUnit = new EmbeddedFieldDef("inAccountUnit",
      constants.inAccountUnit());

  public static EmbeddedFieldDef transportor = new EmbeddedFieldDef("transportor",
      constants.transportor());

  public static EmbeddedFieldDef receiver = new EmbeddedFieldDef("receiver", constants.receiver());

  public static DateFieldDef transportDate = new DateFieldDef("transportDate",
      constants.transportDate(), true, null, true, null, true, GWTFormat.fmt_yMd, false);
