...
import com.hd123.m3.account.gwt.payment.rec.intf.client.ReceiptUrlParams.Log;
 ...
 * 
 */
public class ReceiptLogViewPage extends BaseContentPage implements Log {
  private static ReceiptLogViewPage instance = null;
  private EPReceipt ep = EPReceipt.getInstance();

  public static ReceiptLogViewPage getInstance() {
    if (instance == null)
      instance = new ReceiptLogViewPage();
    return instance;
  }
  ...
  private void refreshTitle() {
    ...
    if (entity != null) {
      ...
      ep.getTitleBar().appendAttributeText(ReceiptMessages.M.log(), "-");
    }
  }
