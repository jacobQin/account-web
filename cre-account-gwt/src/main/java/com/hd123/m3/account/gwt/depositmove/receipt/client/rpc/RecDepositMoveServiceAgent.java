 ...
 * 文件名：	RecDepositMoveServiceAgent.java
 * 模块说明：	
 * 修改历史：
 ...
 * 
 */
public class RecDepositMoveServiceAgent {
  ...
  public static void executeTask(final BProcessContext processCtx, final BOperation operation,
      final BDepositMove entity, boolean saveBeforeAction, final AsyncCallback<Object> callback) {
    RecDepositMoveService.Locator.getService().executeTask(operation, entity, processCtx.getTask(),
        saveBeforeAction, new RBAsyncCallback2<String>() {
          ...
          public void onException(Throwable caught) {
            ...
            String msg = DepositMoveMessage.M.actionFailed(operation.getOutgoingDef().getCaption(),
                ep.getModuleCaption());
