 ...
 * 
 */
public class BizBillConverter implements Converter<BBill, Bill> {
  private static BizBillConverter instance = null;

  public static BizBillConverter getInstance() {
    if (instance == null)
      instance = new BizBillConverter();
    return instance;
  }

  public BizBillConverter() {
  }

  @Override
  public Bill convert(BBill source) throws ConversionException {
    if (source == null)
      return null;
