 ...
 * 
 */
public class PInvoiceReceiveDef {
  public static CPInvoiceReceive constants = (CPInvoiceReceive) GWT.create(CPInvoiceReceive.class);
  ...
  public static EmbeddedFieldDef issuer = new EmbeddedFieldDef("issuer", constants.issuer());

  public static EmbeddedFieldDef receiver = new EmbeddedFieldDef("receiver", constants.receiver());

  public static DateFieldDef receiveDate = new DateFieldDef("receiveDate", constants.receiveDate(),
