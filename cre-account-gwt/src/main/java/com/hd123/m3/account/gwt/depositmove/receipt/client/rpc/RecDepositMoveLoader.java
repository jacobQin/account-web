 ...
 * 
 */
public class RecDepositMoveLoader {
  ...
  public static void decodeParams(JumpParameters params, final Command callback) {
    ...
    if (ep.isProcessMode()) {
      ...
      billUuid = params.getUrlRef().get(RecDepositMoveUrlParams.Base.PN_ENTITY_UUID);
      billNumber = params.getUrlRef().get(RecDepositMoveUrlParams.Base.PN_ENTITY_BILLNUMBER);
    }
    entity = (BDepositMove) params.getExtend().get(EPRecDepositMove.OPN_ENTITY);
  ...
  private static void doLoad(String billUuid, final Command callback) {
    RLoadingDialog.show();
    RecDepositMoveService.Locator.getService().load(billUuid, new RBAsyncCallback2<BDepositMove>() {
      @Override
      public void onException(Throwable caught) {
        RLoadingDialog.hide();
        String msg = DepositMoveMessage.M.cannotFind(RecDepositMoveUrlParams.MODULE_CAPTION);
  ...
  private static void doLoadByNumber(final String billNumber, final Command callback) {
    RLoadingDialog.show();
    RecDepositMoveService.Locator.getService().loadByNumber(billNumber,
        new RBAsyncCallback2<BDepositMove>() {
          ...
          public void onSuccess(BDepositMove result) {
            ...
            if (result != null) {
              ...
              String msg = DepositMoveMessage.M.cannotFind2(RecDepositMoveUrlParams.MODULE_CAPTION,
                  billNumber);
              RMsgBox.showErrorAndBack(msg, null);
            }
