...
public class PInvoiceRegLineDef {

  public static CPInvoiceRegLine constants = (CPInvoiceRegLine) GWT.create(CPInvoiceRegLine.class);
  ...
  public static EmbeddedFieldDef unregTotal = new EmbeddedFieldDef("unregTotal", constants.unregTotal());

  public static BigDecimalFieldDef unregTotal_tax = new BigDecimalFieldDef("unregTotal.tax", constants.unregTotal_tax(), false, null, true, null, true, 2);

  public static BigDecimalFieldDef unregTotal_total = new BigDecimalFieldDef("unregTotal.total", constants.unregTotal_total(), false, null, true, null, true, 2);
