 ...
 * 文件名：	PInvoiceReturnDef.java
 * 模块说明：	
 * 修改历史：
 * 2015年12月13日 - lixiaohong - 创建。
 */
package com.hd123.m3.account.gwt.ivc.returns.intf.client.dd;
 ...
 * 
 */
public class PInvoiceReturnDef {
  public static CPInvoiceReturn constants = (CPInvoiceReturn) GWT.create(CPInvoiceReturn.class);
  ...
  public static EmbeddedFieldDef returnor = new EmbeddedFieldDef("returnor", constants.returnor());

  public static DateFieldDef returnDate = new DateFieldDef("returnDate", constants.returnDate(),
