 ...
 * 
 */
public class InvoiceExchangeEviToEviViewWidget extends RCaptionBox {
  ...
  public InvoiceExchangeEviToEviViewWidget() {
  ...
  private void drawGrid() {
    ...
    invoiceCodeCol = new RGridColumnDef(PInvoiceExchBalanceLineDef.oldReceiptCode);
    invoiceCodeCol.setWidth("180px");
    grid.addColumnDef(invoiceCodeCol);

    invoiceNumberCol = new RGridColumnDef(PInvoiceExchBalanceLineDef.oldReceiptNumber);
