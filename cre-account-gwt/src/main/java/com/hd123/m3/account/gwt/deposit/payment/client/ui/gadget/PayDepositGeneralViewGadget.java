 ...
 * 
 */
public class PayDepositGeneralViewGadget extends RCaptionBox {

  private EPPayDeposit ep = EPPayDeposit.getInstance(EPPayDeposit.class);

  public PayDepositGeneralViewGadget() {
    drawSelf();
  }
  ...
  private Widget drawGeneralPanel() {
    ...
    countPartField = new RViewStringField(EPPayDeposit.getInstance().getFieldCaption(
        GRes.FIELDNAME_COUNTERPART, GRes.R.counterpart()));
    generalForm.addField(countPartField);

    contractNumberField = new DispatchLinkField(PDepositDef.constants.contract_code());
  ...
  private Widget drawPayInfoPanel() {
    ...
    depositDateField = new RViewDateField(EPPayDeposit.depositDate);
  ...
  public void refresh(BDeposit entity) {
    ...
    if (entity.getContract() == null) {
      ...
      if (entity.getCounterpart() != null
        ...
        contractNumberField.setValue(GRes.FIELDNAME_LEASEBACKCONTRACT_BILLTYPE, entity.getContract()
            .getCode());
      } else {
        contractNumberField.setValue(GRes.FIELDNAME_CONTRACT_BILLTYPE, entity.getContract().getCode());
      }
    }
    contractNameField
  ...
  private class Handler_viewLogAction implements ClickHandler {
    ...
    public void onClick(ClickEvent event) {
      JumpParameters params = new JumpParameters(PayDepositLogViewPage.START_NODE);
      params.getUrlRef().set(PayDepositLogViewPage.PN_UUID, entity.getUuid());
      ep.jump(params);
    }
  }
}
