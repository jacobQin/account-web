 ...
 * 文件名：	RecDepositRepaymentLineViewGadget.java
 * 模块说明：	
 * 修改历史：
 ...
 * 
 */
public class RecDepositRepaymentLineViewGadget extends RCaptionBox {
  public RecDepositRepaymentLineViewGadget() {
    drawSelf();
  }
  ...
  private class GridDataProvider implements RGridDataProvider {
    ...
    public Object getData(int row, int col) {
      ...
      if (col == lineNumberCol.getIndex()) {
        ...
        return entity.getLines().get(row).getSubject()==null?null:entity.getLines().get(row).getSubject().toFriendlyStr();
