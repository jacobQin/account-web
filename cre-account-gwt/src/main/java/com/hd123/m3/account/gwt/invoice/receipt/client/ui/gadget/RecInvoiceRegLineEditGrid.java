 ...
 * 
 */
public class RecInvoiceRegLineEditGrid extends Composite implements RActionHandler,
    HasRActionHandlers {
  ...
  public RecInvoiceRegLineEditGrid() {
    ...
    public void onHighlight(HighlightEvent<Point> event) {
      ...
      CommandQueue.offer(new LocalCommand() {
        ...
        public void onCall(CommandQueue queue) {
          if (currentRow != row) {
            currentRow = row;
            RActionEvent.fire(RecInvoiceRegLineEditGrid.this, InvoiceRegActionName.CHANGE_LINE,
