 ...
 */
package com.hd123.m3.account.gwt.invoice.receipt.intf.client;
 ...
 * 
 */
public class RecInvoiceRegUrlParams {
  public static final String MODULE_CAPTION = "收款发票登记单";
  public static final String ENTRY_MODULE = "invoice.receipt.RecInvoiceReg";
  public static final String ENTRY_FILE = "RecInvoiceReg.html";
  ...
  public static interface Flecs {
    ...
    /** 搜索条件的分组ID */
    public static final String GROUP_ID = "invoice.RecInvoiceRegSearch";
    /** 授权组 */
