...
public class PFreezeLineDef {

  public static CPFreezeLine constants = (CPFreezeLine) GWT.create(CPFreezeLine.class);
  ...
  public static JoinFieldDef freeze = new JoinFieldDef("freeze", constants.freeze(), false);
