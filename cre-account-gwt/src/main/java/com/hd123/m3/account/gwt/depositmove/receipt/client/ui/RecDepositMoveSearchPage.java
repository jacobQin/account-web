 ...
 * 文件名：	RecDepositMoveSearchPage.java
 * 模块说明：	
 * 修改历史：
...
import com.hd123.m3.account.gwt.depositmove.receipt.intf.client.RecDepositMoveUrlParams.Search;
 ...
 * 
 */
public class RecDepositMoveSearchPage extends BaseBpmSearchPage implements Search,
    BeforePrintHandler {
  ...
  private static EmbeddedFieldDef businessUnit = new EmbeddedFieldDef("businessUnit",
      EPRecDepositMove.getInstance().getFieldCaption(GRes.FIELDNAME_BUSINESS, GRes.R.business()));
  ...
  private static EmbeddedFieldDef outCounterpartType = new EmbeddedFieldDef(
      RecDepositMoveUrlParams.Flecs.FIELD_OUTCOUNTERPARTTYPE, "转出"
          + EPRecDepositMove.getInstance().getFieldCaption(GRes.FIELDNAME_COUNTERPART_TYPE,
              GRes.R.counterpartType()));
  private static EmbeddedFieldDef inCounterpartType = new EmbeddedFieldDef(
      RecDepositMoveUrlParams.Flecs.FIELD_INCOUNTERPARTTYPE, "转入"
          + EPRecDepositMove.getInstance().getFieldCaption(GRes.FIELDNAME_COUNTERPART_TYPE,
              GRes.R.counterpartType()));

  private static RecDepositMoveSearchPage instance = null;

  public static RecDepositMoveSearchPage getInstance() {
    if (instance == null) {
      instance = new RecDepositMoveSearchPage();
    }
    return instance;
  }
  ...
  public RecDepositMoveSearchPage() {
    super();
    drawToolbar();
    drawSelf();
    afterDraw();
  ...
  private Widget drawGrid() {
    ...
    billNumberCol.setName(RecDepositMoveUrlParams.Search.FIELD_BILLNUMBER);
    ...
    bizStateCol.setName(RecDepositMoveUrlParams.Search.FIELD_BIZSTATE);
    bizStateCol.setWidth("60px");
    grid.addColumnDef(bizStateCol);

    outCountPartCol = new RGridColumnDef(DepositMoveMessage.M.out()
        + EPRecDepositMove.getInstance().getFieldCaption(GRes.FIELDNAME_COUNTERPART,
            GRes.R.counterpart()));
    outCountPartCol.setSortable(true);
    outCountPartCol.setName(RecDepositMoveUrlParams.Search.FIELD_OUTCOUNTERPART);
    ...
    outContractNumberCol.setName(RecDepositMoveUrlParams.Search.FIELD_OUTCONTRACTNUMBER);
    ...
    outContractNameCol.setName(RecDepositMoveUrlParams.Search.FIELD_OUTCONTRACTNAME);
    ...
    outSubjectCol.setName(RecDepositMoveUrlParams.Search.FIELD_OUTSUBJECT);
    ...
    amountCol.setName(RecDepositMoveUrlParams.Search.FIELD_AMOUNT);
    ...
    accountDateCol.setName(RecDepositMoveUrlParams.Search.FIELD_ACCOUNTDATE);
    ...
    inCountPartCol.setName(RecDepositMoveUrlParams.Search.FIELD_INCOUNTERPART);
    ...
    inContractNumberCol.setName(RecDepositMoveUrlParams.Search.FIELD_INCONTRACTNUMBER);
    ...
    inContractNameCol.setName(RecDepositMoveUrlParams.Search.FIELD_INCONTRACTNAME);
    ...
    inSubjectCol.setName(RecDepositMoveUrlParams.Search.FIELD_INSUBJECT);
    ...
    remarkCol.setName(RecDepositMoveUrlParams.Search.FIELD_REMARK);
    ...
    setterNoCol.setName(RecDepositMoveUrlParams.Search.FIELD_SETTLENO);
  ...
  private void refreshCommonds() {
    deleteAction.setVisible(getEP().isPermitted(RecDepositMovePermDef.DELETE));
    effectAction.setVisible(getEP().isPermitted(RecDepositMovePermDef.EFFECT));
    abortAction.setVisible(getEP().isPermitted(RecDepositMovePermDef.ABORT));
  ...
  private boolean checkIn() {
    if (getEP().isPermitted(RecDepositMovePermDef.READ) == false) {
      ...
      batchProcessor.batchProcess(DepositMoveMessage.M.effect(), new BDepositMove[] {},
          new PagingGridBatchProcessCallback<BDepositMove>() {
            ...
            public void execute(BDepositMove entity, BatchProcesser<BDepositMove> processer,
              ...
              RecDepositMoveService.Locator.getService().effect(entity.getUuid(), null,
      ...
      batchProcessor.batchProcess(DepositMoveMessage.M.abort(), new BDepositMove[] {},
          new PagingGridBatchProcessCallback<BDepositMove>() {
            ...
            public void execute(BDepositMove entity, BatchProcesser<BDepositMove> processer,
              ...
              RecDepositMoveService.Locator.getService().abort(entity.getUuid(), null,
                  entity.getVersion(), callback);
      ...
      batchProcessor.batchProcess(DepositMoveMessage.M.delete(), new BDepositMove[] {},
          new PagingGridBatchProcessCallback<BDepositMove>() {
            ...
            public void execute(BDepositMove entity, BatchProcesser<BDepositMove> processer,
              ...
              RecDepositMoveService.Locator.getService().remove(entity.getUuid(),
                  entity.getVersion(), callback);
  ...
  private class Handler_editMenuItem implements ClickHandler {
    ...
    public void onClick(ClickEvent event) {
      ...
      JumpParameters jumParams = new JumpParameters(RecDepositMoveEditPage.START_NODE);
      jumParams.getUrlRef().set(RecDepositMoveEditPage.PN_ENTITY_UUID, pay.getUuid());
      getEP().jump(jumParams);
    }
  }
  ...
  private void doDeleteOne(final BDepositMove pay) {
    ...
    RecDepositMoveService.Locator.getService().remove(pay.getUuid(), pay.getVersion(),
          ...
          public void onSuccess(Object result) {
            ...
            getMessagePanel().putInfoMessage(
                DepositMoveMessage.M.onSuccess(DepositMoveMessage.M.delete(),
                    RecDepositMoveUrlParams.MODULE_CAPTION, pay.getBillNumber()));
            pagingGrid.refresh();
          }
        });
  }
  ...
  private void effectOne(final BDepositMove bill) {
    RLoadingDialog.show(DepositMoveMessage.M.beDoing(DepositMoveMessage.M.effect(),
        bill.getBillNumber()));
    RecDepositMoveService.Locator.getService().effect(bill.getUuid(), null, bill.getVersion(),
        new RBAsyncCallback2() {
  ...
  private void abortOne(final BDepositMove bill) {
    RLoadingDialog.show(DepositMoveMessage.M.beDoing(DepositMoveMessage.M.abort(),
        bill.getBillNumber()));
    RecDepositMoveService.Locator.getService().abort(bill.getUuid(), null, bill.getVersion(),
        new RBAsyncCallback2() {
  ...
  private class GridDataProvider implements RPageDataProvider<BDepositMove> {
    ...
    public void fetchData(int page, int pageSize, String sortField, OrderDir sortDir,
      ...
      if (sortField != null)
        ...
        pageSort.appendOrder(RecDepositMoveUrlParams.Search.FIELD_BILLNUMBER, "desc");

      RecDepositMoveService.Locator.getService().query(
