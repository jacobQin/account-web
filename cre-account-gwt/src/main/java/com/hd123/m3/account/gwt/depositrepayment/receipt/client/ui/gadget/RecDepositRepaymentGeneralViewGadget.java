 ...
 * 文件名：	RecDepositRepaymentGeneralViewGadget.java
 * 模块说明：	
 * 修改历史：
 ...
 * 
 */
public class RecDepositRepaymentGeneralViewGadget extends RCaptionBox {
  public RecDepositRepaymentGeneralViewGadget() {
    drawSelf();
  }
  ...
  private DispatchLinkField depositBillNumberField;
  ...
  private Widget drawGeneralPanel() {
    ...
    accountUnitField.setCaption(EPRecDepositRepayment.getInstance().getFieldCaption(
        GRes.FIELDNAME_BUSINESS, GRes.R.business()));
    generalForm.addField(accountUnitField);

    countPartField = new RViewStringField(EPRecDepositRepayment.getInstance().getFieldCaption(
    ...
    depositBillNumberField = new DispatchLinkField("预存款单");
    depositBillNumberField.setLinkKey(GRes.R.dispatch_key());
    depositBillNumberField.setVisible(ep.isEnableByDeposit());
    generalForm.addField(depositBillNumberField);
  ...
  private Widget drawRecInfoPanel() {
  ...
  public void refresh(BDepositRepayment entity) {
    ...
    if (entity.getContract() == null) {
      contractNumberField.setValue(entity.getContract() == null ? null : entity.getContract()
          .getCode());
    } else {
    ...
    depositBillNumberField.setValue("receiptDeposit", entity.getDeposit() == null ? null : entity
        .getDeposit().getCode());
    contractNameField
    ...
    permGroupField.refresh(EPRecDepositRepayment.getInstance().isPermEnabled(), entity);
  ...
  private class Handler_viewLogAction implements ClickHandler {
    ...
    public void onClick(ClickEvent event) {
      JumpParameters params = new JumpParameters(RecDepositRepaymentLogViewPage.START_NODE);
      params.getUrlRef().set(RecDepositRepaymentLogViewPage.PN_ENTITY_UUID, entity.getUuid());
      EPRecDepositRepayment.getInstance().jump(params);
    }
  }
