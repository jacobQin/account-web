...
import com.hd123.m3.account.gwt.deposit.payment.client.ui.gadget.PayDepositGeneralViewGadget;
import com.hd123.m3.account.gwt.deposit.payment.client.ui.gadget.PayDepositLineViewGadget;
import com.hd123.m3.account.gwt.deposit.payment.intf.client.PayDepositUrlParams;
import com.hd123.m3.account.gwt.deposit.payment.intf.client.PayDepositUrlParams.View;
 ...
 * 
 */
public class PayDepositViewPage extends BaseBpmViewPage implements View {
  private static PayDepositViewPage instance = null;

  public static PayDepositViewPage getInstance() {
    if (instance == null)
      instance = new PayDepositViewPage();
    return instance;
  }

  public PayDepositViewPage() {
    super();
    drawToolbar();
    drawSelf();
  }
  ...
  private PayDepositGeneralViewGadget generalGadget;
  private PayDepositLineViewGadget lineViewGadget;
  ...
  private void drawSelf() {
    ...
    generalGadget = new PayDepositGeneralViewGadget();
    panel.add(generalGadget);

    lineViewGadget = new PayDepositLineViewGadget();
  ...
  private class Handler_editAction implements ClickHandler {
    ...
    public void onClick(ClickEvent event) {
      JumpParameters params = new JumpParameters(PayDepositUrlParams.Edit.START_NODE);
      params.getUrlRef().set(PayDepositUrlParams.Edit.PN_UUID, entity.getUuid());
      getEP().jump(params);
    }
  }
  ...
  private class ProcessDialog extends M3BaseOutgoingDialog {
    ...
    protected void doExcute(BOperation operation, AsyncCallback<Object> callback) {
      ...
      PayDepositServiceAgent.executeTask(processCtx, operation, entity, false, this);
    }
  }
