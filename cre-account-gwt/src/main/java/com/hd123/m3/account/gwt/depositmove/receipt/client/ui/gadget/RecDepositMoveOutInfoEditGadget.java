 ...
 * 文件名：	RecDepositMoveOutInfoEditGadget.java
 * 模块说明：	
 * 修改历史：
 * 2014-2-27 - zhuhairui - 创建。
 */
package com.hd123.m3.account.gwt.depositmove.receipt.client.ui.gadget;
 ...
 * 
 */
public class RecDepositMoveOutInfoEditGadget extends RCaptionBox implements HasRActionHandlers,
    RActionHandler {
  private EPRecDepositMove ep = EPRecDepositMove.getInstance();

  public RecDepositMoveOutInfoEditGadget() {
    drawSelf();
  }
  ...
  private void drawSelf() {
    ...
    contractBox.setDirection(DirectionType.receipt.getDirectionValue());
    ...
    subjectUCNBox.setDirection(DirectionType.receipt.getDirectionValue());
    ...
    if (entity.getOutSubject() != null && entity.getOutSubject().getCode() != null) {
      ...
      RMsgBox.showConfirm(msg, new ConfirmCallback() {
        ...
        public void onClosed(boolean confirmed) {
          ...
          doRefrechBalance();
          RActionEvent
              .fire(RecDepositMoveOutInfoEditGadget.this, DepositMoveActionName.GET_BALANCE);
        }
      });
    } else {
      entity.setAccountUnit(accountUnitUCNBox.getValue());
      ...
      doRefreshSubject();
      doRefrechBalance();
      RActionEvent.fire(RecDepositMoveOutInfoEditGadget.this, DepositMoveActionName.GET_BALANCE);
    }
  }
    ...
    if (hasOutSubject || hasInInfo) {
      RMsgBox.showConfirm(msg, new ConfirmCallback() {
        ...
        public void onClosed(boolean confirmed) {
          ...
          doRefreshSubject();
          doRefrechBalance();
          RActionEvent.fire(RecDepositMoveOutInfoEditGadget.this,
  ...
  private void doRefreshContract() {
    ...
    RecDepositMoveService.Locator.getService().getUniqueContract(entity.getAccountUnit().getUuid(),
        entity.getOutCounterpart().getUuid(), entity.getOutCounterpart().getCounterpartType(),
        // 对方单位类型
  ...
  private void doRefrechBalance() {
    ...
    RecDepositMoveService.Locator.getService().getBalance(entity.getAccountUnit().getUuid(),
