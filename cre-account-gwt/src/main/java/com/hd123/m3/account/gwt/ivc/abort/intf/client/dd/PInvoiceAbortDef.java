 ...
 *
 */
public class PInvoiceAbortDef {
  public static CPInvoiceAbort constants = (CPInvoiceAbort) GWT.create(CPInvoiceAbort.class);
  ...
  public static EmbeddedFieldDef aborter = new EmbeddedFieldDef("aborter", constants.aborter());

  public static DateFieldDef abortDate = new DateFieldDef("abortDate", constants.abortDate(),
