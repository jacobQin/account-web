...
import com.hd123.m3.account.gwt.invoice.payment.intf.client.PayInvoiceRegUrlParams.Search;
 ...
 * 
 */
public class PayInvoiceRegSearchPage extends BaseBpmSearchPage implements Search,
    BeforePrintHandler {
  private static PayInvoiceRegSearchPage instance = null;
  ...
  public static EmbeddedFieldDef counterpartType = new EmbeddedFieldDef(
      PayInvoiceRegUrlParams.Flecs.FIELD_COUNTERPARTTYPE, EPPayInvoiceReg.getInstance()
          .getFieldCaption(GRes.FIELDNAME_COUNTERPART_TYPE, GRes.R.counterpartType()));

  public static PayInvoiceRegSearchPage getInstance() {
    if (instance == null) {
      instance = new PayInvoiceRegSearchPage();
    }
    return instance;
  }
  ...
  public PayInvoiceRegSearchPage() {
    super();
    drawToolbar();
    drawSelf();
    afterDraw();
  ...
  private Widget drawGrid() {
    ...
    billNumberCol.setName(PayInvoiceRegUrlParams.Search.FIELD_BILLNUMBER);
    ...
    bizStateCol.setName(PayInvoiceRegUrlParams.Search.FIELD_BIZSTATE);
    ...
    accountUnitCol.setName(PayInvoiceRegUrlParams.Search.FIELD_ACCOUNTUNIT);
    ...
    countpartCol.setName(PayInvoiceRegUrlParams.Search.FIELD_COUNTERPART);
    ...
    setterNoCol.setName(PayInvoiceRegUrlParams.Search.FIELD_SETTLENO);
    ...
    regDateCol.setName(PayInvoiceRegUrlParams.Search.FIELD_REGDATE);
    ...
    invoiceTotalCol.setName(PayInvoiceRegUrlParams.Search.FIELD_INVOICETOTAL_TOTAL);
    ...
    invoiceTaxCol.setName(PayInvoiceRegUrlParams.Search.FIELD_INVOICETOTAL_TAX);
    ...
    accountTotalCol.setName(PayInvoiceRegUrlParams.Search.FIELD_ACCOUNTTOTAL_TOTAL);
    ...
    accountTaxCol.setName(PayInvoiceRegUrlParams.Search.FIELD_ACCOUNTTOTAL_TAX);
    ...
    totalDiffCol.setName(PayInvoiceRegUrlParams.Search.FIELD_TOTALDIFF);
    ...
    taxDiffCol.setName(PayInvoiceRegUrlParams.Search.FIELD_TAXDIFF);
  ...
  private void refreshCommonds() {
    configAction.setEnabled(getEP().isPermitted(PayInvoiceRegPermDef.CONFIG));
    deleteAction.setVisible(getEP().isPermitted(PayInvoiceRegPermDef.DELETE));
    effectAction.setVisible(getEP().isPermitted(PayInvoiceRegPermDef.EFFECT));
    abortAction.setVisible(getEP().isPermitted(PayInvoiceRegPermDef.ABORT));
  ...
  private void doConfig() {
    if (configDialog == null)
      configDialog = new InvoiceRegConfigDialog(DirectionType.payment.getDirectionValue(),
  ...
  private void doEditOne() {
    ...
    JumpParameters jumParams = new JumpParameters(PayInvoiceRegEditPage.START_NODE);
    jumParams.getUrlRef().set(PayInvoiceRegEditPage.PN_UUID, entity.getUuid());
    getEP().jump(jumParams);
  }
  ...
  private class GridDataProvider implements RPageDataProvider<BInvoiceReg> {
    ...
    public void fetchData(int page, int pageSize, String sortField, OrderDir sortDir,
      ...
      if (sortField != null)
        ...
        pageSort.appendOrder(PayInvoiceRegUrlParams.Search.FIELD_BILLNUMBER, "desc");

      PayInvoiceRegService.Locator.getService().query(
