package com.hd123.m3.account.gwt.bank.intf.client.dd;
...
public class PBankDef {

  public static CPBank constants = (CPBank) GWT.create(CPBank.class);

  public static String TABLE_CAPTION = constants.tableCaption();

  public static StringFieldDef account = new StringFieldDef("account", constants.account(), true,
      0, 50);

  public static StringFieldDef address = new StringFieldDef("address", constants.address(), true,
      0, 128);

  public static StringFieldDef bank = new StringFieldDef("bank", constants.bank(), true, 0, 128);

  public static StringFieldDef code = new StringFieldDef("code", constants.code(), false, 0, 32,
      "^[\\w\\.\\-\\+]+$", "只能包含字母、数字、\"_\"、\".\"、\"-\"、\"+\"。");
  ...
  public static StringFieldDef name = new StringFieldDef("name", constants.name(), false, 0, 32);
