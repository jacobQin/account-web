...
public class QStatement implements Serializable {
  ...
  private static final long serialVersionUID = 3303167786673447287L;

  public static final String FIELD_BILLNUMBER = "billNumber";
  public static final String FIELD_SETTLENO = "settle";
  public static final String FIELD_COUNTERPART = "counterpartCode";
  public static final String FIELD_CONTRACTNUM = "contractNumber";
  public static final String FIELD_CONTRACTTITLE = "contractTitle";
  public static final String FIELD_ACCOUNTTYPENAME = "accountType";
