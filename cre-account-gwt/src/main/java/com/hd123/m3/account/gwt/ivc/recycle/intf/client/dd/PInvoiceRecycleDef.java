 ...
 * 
 */
public class PInvoiceRecycleDef {
  public static CPInvoiceRecycle constants = (CPInvoiceRecycle) GWT.create(CPInvoiceRecycle.class);
  ...
  public static DateFieldDef recycleDate = new DateFieldDef("recycleDate", constants.recycleDate(),
