 ...
 * 
 */
public class PayInvoiceRegInvoiceEditGrid extends Composite implements HasRActionHandlers,
    RActionHandler {
  ...
  public PayInvoiceRegInvoiceEditGrid() {
  ...
  public void refresh() {
    ...
    if (entity.getInvoices().size() == 0) {
      ...
      line.setTaxRate(EPPayInvoiceReg.getInstance().getDefaultValue().getTaxRate());
  ...
  private class Handler_grid implements ClickHandler {
    ...
    public void onClick(ClickEvent event) {
      ...
      RActionEvent.fire(PayInvoiceRegInvoiceEditGrid.this, InvoiceRegActionName.CHANGE_INVOICE,
  ...
  private class GridDataProvider implements RGridDataProvider {
    ...
    public Object getData(int row, int col) {
      ...
      case 1:
        return EPPayInvoiceReg.getInstance().getInvoiceTypeMap().get(invoice.getInvoiceType());
      case 2:
      ...
      case 4:
        return invoice.getTotal() == null || invoice.getTotal().getTotal() == null
            ...
            .getTotal().getTotal().subtract(invoice.getTotal().getTax()));
      case 5:
