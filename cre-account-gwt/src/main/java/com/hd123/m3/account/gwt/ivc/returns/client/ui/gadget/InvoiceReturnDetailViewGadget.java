 ...
 * 文件名：	InvoiceReturnDetailViewGadget.java
 * 模块说明：	
 * 修改历史：
 ...
 *
 */
public class InvoiceReturnDetailViewGadget extends RCaptionBox{
  ...
  public InvoiceReturnDetailViewGadget() {
    super();
  ...
  private class GridDataProvider implements RGridDataProvider, EditGridDataProduce<BInvoiceLine> {
    ...
    public int getRowCount() {
      return entity == null || entity.getReturnLines() == null ? 0 : entity.getReturnLines()
          .size();
    }
