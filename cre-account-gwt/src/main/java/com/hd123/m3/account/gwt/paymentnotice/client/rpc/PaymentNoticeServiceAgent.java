 ...
 * 文件名：	PaymentNoticeServiceAgent.java
 * 模块说明：	
 * 修改历史：
 ...
 * 
 */
public class PaymentNoticeServiceAgent {
  private static EPPaymentNotice ep = EPPaymentNotice.getInstance();

  public static void executeTask(final BOperation operation, final BPaymentNotice entity,
      final BProcessContext processCtx, boolean saveBeforeAction, final AsyncCallback<Object> callback) {
    PaymentNoticeService.Locator.getService().executeTask(operation, entity, processCtx.getTask(),
        saveBeforeAction, new RBAsyncCallback2<String>() {
          ...
          public void onException(Throwable caught) {
            ...
            String msg = PaymentNoticeMessages.M.actionFailed(operation.getOutgoingDef()
