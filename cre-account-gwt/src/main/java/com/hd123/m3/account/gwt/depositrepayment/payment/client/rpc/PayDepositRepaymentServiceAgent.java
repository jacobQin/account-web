 ...
 * 文件名：	DepositRepaymentServiceAgent.java
 * 模块说明：	
 * 修改历史：
 ...
 * 
 */
public class PayDepositRepaymentServiceAgent {
  ...
  public static void executeTask(final BProcessContext processCtx, final BOperation operation,
    ...
    PayDepositRepaymentService.Locator.getService().executeTask(operation, entity,
