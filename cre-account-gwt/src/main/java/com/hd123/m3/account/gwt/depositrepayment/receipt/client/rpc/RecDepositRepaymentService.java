 ...
 * 文件名：	RecDepositRepaymentService.java
 * 模块说明：	
 * 修改历史：
 ...
 * 
 */
@RemoteServiceRelativePath("account/recDepositRepayment")
public interface RecDepositRepaymentService extends M3ModuleService, M3ModuleNaviService {
  ...
  public static class Locator {
    private static RecDepositRepaymentServiceAsync service = null;

    public static RecDepositRepaymentServiceAsync getService() {
      if (service == null)
        service = GWT.create(RecDepositRepaymentService.class);
      return service;
    }
  }
