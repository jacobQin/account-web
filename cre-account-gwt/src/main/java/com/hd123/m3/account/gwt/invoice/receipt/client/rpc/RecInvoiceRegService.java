 ...
 * 
 */
@RemoteServiceRelativePath("account/recInvoiceReg")
public interface RecInvoiceRegService extends M3ModuleService, M3ModuleNaviService {
  ...
  public static class Locator {
    private static RecInvoiceRegServiceAsync service = null;

    public static RecInvoiceRegServiceAsync getService() {
      if (service == null)
        service = GWT.create(RecInvoiceRegService.class);
      return service;
    }
  }
