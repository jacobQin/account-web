 ...
 * 模块说明：	
 * 修改历史：
 * 2014-03-10 - zhuhairui - 创建。
 */
package com.hd123.m3.account.gwt.depositmove.payment.intf.client;
 ...
 * 
 */
public class PayDepositMoveUrlParams {
  public static final String MODULE_CAPTION = "预付款转移单";
  public static final String ENTRY_MODULE = "depositmove.payment.PayDepositMove";
  public static final String ENTRY_FILE = "PayDepositMove.html";
  ...
  public static interface Flecs {
    ...
    /** 搜索条件的分组ID */
    public static final String GROUP_ID = "depositmove.PayDepositMove";
