 ...
 * 
 */
public class RecDepositGeneralEditGadget extends RCaptionBox implements RActionHandler,
    HasRActionHandlers {

  private EPRecDeposit ep = EPRecDeposit.getInstance(EPRecDeposit.class);

  public RecDepositGeneralEditGadget() {
    drawSelf();
  }
  ...
  private void onChangeContract() {
    ...
    RActionEvent.fire(RecDepositGeneralEditGadget.this, DepositActionName.CHANGE_REMAINTOTAL);
  }
}
