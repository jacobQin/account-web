 ...
 * 文件名：	RecDepositRepaymentViewPage.java
 * 模块说明：	
 * 修改历史：
...
import com.hd123.m3.account.gwt.depositrepayment.receipt.client.ui.gadget.RecDepositRepaymentGeneralViewGadget;
import com.hd123.m3.account.gwt.depositrepayment.receipt.client.ui.gadget.RecDepositRepaymentLineViewGadget;
import com.hd123.m3.account.gwt.depositrepayment.receipt.intf.client.RecDepositRepaymentUrlParams;
import com.hd123.m3.account.gwt.depositrepayment.receipt.intf.client.RecDepositRepaymentUrlParams.View;
 ...
 * 
 */
public class RecDepositRepaymentViewPage extends BaseBpmViewPage implements View {
  private static RecDepositRepaymentViewPage instance = null;

  public static RecDepositRepaymentViewPage getInstance() {
    if (instance == null)
      instance = new RecDepositRepaymentViewPage();
    return instance;
  }

  public RecDepositRepaymentViewPage() {
    super();
    drawToolbar();
    drawSelf();
  }
  ...
  private RecDepositRepaymentGeneralViewGadget generalGadget;
  private RecDepositRepaymentLineViewGadget lineViewGadget;
  ...
  private void drawSelf() {
    ...
    generalGadget = new RecDepositRepaymentGeneralViewGadget();
    panel.add(generalGadget);

    lineViewGadget = new RecDepositRepaymentLineViewGadget();
  ...
  private class Handler_editAction implements ClickHandler {
    ...
    public void onClick(ClickEvent event) {
      JumpParameters params = new JumpParameters(RecDepositRepaymentUrlParams.Edit.START_NODE);
      params.getUrlRef().set(RecDepositRepaymentUrlParams.Edit.PN_ENTITY_UUID, entity.getUuid());
      getEP().jump(params);
    }
  }
  ...
  private class Handler_deleteAction implements ClickHandler {
    ...
    public void onClick(ClickEvent event) {
      ...
      String msg = DepositRepaymentMessage.M.actionComfirm2(DepositRepaymentMessage.M.delete(),
          RecDepositRepaymentUrlParams.MODULE_CAPTION, entity.toFriendlyStr());
  ...
  private void doDelete() {
    ...
    RecDepositRepaymentService.Locator.getService().remove(entity.getUuid(), entity.getVersion(),
  ...
  private void doEffect() {
    ...
    RecDepositRepaymentService.Locator.getService().effect(entity.getUuid(), null,
  ...
  private void doAbort() {
    RLoadingDialog.show(DepositRepaymentMessage.M.beDoing(DepositRepaymentMessage.M.abort(),
        entity.getBillNumber()));
    RecDepositRepaymentService.Locator.getService().abort(entity.getUuid(), null,
        entity.getVersion(), new RBAsyncCallback2() {
  ...
  private class ProcessDialog extends M3BaseOutgoingDialog {
    ...
    protected void doExcute(BOperation operation, AsyncCallback<Object> callback) {
      ...
      RecDepositRepaymentServiceAgent.executeTask(processCtx, operation, entity, false, this);
    }
  }
