 ...
 */
package com.hd123.m3.account.gwt.deposit.receipt.intf.client;
 ...
 * 
 */
public class RecDepositUrlParams {

  public static final String MODULE_CAPTION = "预存款单";
  public static final String ENTRY_MODULE = "deposit.receipt.RecDeposit";
  public static final String ENTRY_FILE = "RecDeposit.html";
  ...
  public static interface Flecs {
    ...
    /** 搜索条件的分组ID */
    public static final String GROUP_ID = "deposit.PayDeposit";
