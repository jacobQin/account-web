 ...
 * 
 */
@RemoteServiceRelativePath("account/recDeposit")
public interface RecDepositService extends M3ModuleService, M3ModuleNaviService {
  public static class Locator {
    private static RecDepositServiceAsync service = null;

    public static RecDepositServiceAsync getService() {
      if (service == null)
        service = GWT.create(RecDepositService.class);
      return service;
    }
  }
