...
/**
 * AccountAdj -> BInvoiceStockRegLine
 * 
 * @author LiBin
 * 
 */
public class AccountAdjToBInvoiceStockRegLineConverter implements
    Converter<AccountAdj, BInvoiceStockRegLine> {

  private List<BillType> billTypes = new ArrayList<BillType>();

  private static AccountAdjToBInvoiceStockRegLineConverter instance = null;

  public static AccountAdjToBInvoiceStockRegLineConverter getInstance(List<BillType> billTypes) {
    if (instance == null) {
      instance = new AccountAdjToBInvoiceStockRegLineConverter();
    }
  ...
  @Override
  public BInvoiceStockRegLine convert(AccountAdj source) throws ConversionException {
    if (source == null) {
      return null;
    }
