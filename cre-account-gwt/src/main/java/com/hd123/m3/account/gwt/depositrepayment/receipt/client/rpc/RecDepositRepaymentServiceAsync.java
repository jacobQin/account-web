 ...
 * 文件名：	RecDepositRepaymentServiceAsync.java
 * 模块说明：	
 * 修改历史：
 ...
 * 
 */
public interface RecDepositRepaymentServiceAsync extends M3ModuleServiceAsync,
  ...
  public void queryDeposit(RecDepositFilter filter, AsyncCallback<RPageData<BDeposit>> callback);

  public void getDepositByBillNumber(RecDepositFilter filter, AsyncCallback<BDeposit> callback);
  ...
  public void getAdvance(String accountUnitUuid, String counterpartUuid, String subjectUuid,
      String billUuid, AsyncCallback<BigDecimal> callback);
