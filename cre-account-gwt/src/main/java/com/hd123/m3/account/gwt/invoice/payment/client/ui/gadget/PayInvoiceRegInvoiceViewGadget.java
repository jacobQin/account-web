 ...
 * 
 */
public class PayInvoiceRegInvoiceViewGadget extends RCaptionBox {

  public PayInvoiceRegInvoiceViewGadget() {
    drawSelf();
  }
  ...
  private class GridDataProvider implements RGridDataProvider {
    ...
    public Object getData(int row, int col) {
      ...
      if (col == lineNumberCol.getIndex()) {
        ...
        return invoice.getInvoiceType() == null ? null : EPPayInvoiceReg.getInstance()
