...
public class PDepositDef {

  public static CPDeposit constants = (CPDeposit) GWT.create(CPDeposit.class);
...
//  public static DateFieldDef depositDate = new DateFieldDef("depositDate", constants.depositDate(), true, null, true, null, true, GWTFormat.fmt_yMd, false);
