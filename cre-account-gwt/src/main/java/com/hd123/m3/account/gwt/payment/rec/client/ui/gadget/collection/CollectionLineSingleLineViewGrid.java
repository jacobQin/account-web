 ...
 * 文件名：	CollectionLineSingleLineViewGrid.java
 * 模块说明：	
 * 修改历史：
 * 2016年3月20日 - LiBin - 创建。
 */
 ...
 * 
 */
public class CollectionLineSingleLineViewGrid extends RCaptionBox {
  ...
  public CollectionLineSingleLineViewGrid() {
    drawToolbar();
    drawSelf();
  }
  ...
  private Widget drawGrid() {
    ...
    receivablleTotalCol.setWidth("100px");
    ...
    unreceivableCol.setWidth("100px");
  ...
  private class GridDataProvider implements RGridDataProvider,
    ...
    public Object getData(int row, int col) {
      ...
      } else if (col == paymentTypeCol.getIndex()) {
