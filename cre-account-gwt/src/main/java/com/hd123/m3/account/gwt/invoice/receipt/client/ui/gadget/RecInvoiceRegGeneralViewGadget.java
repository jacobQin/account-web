 ...
 * 
 */
public class RecInvoiceRegGeneralViewGadget extends RCaptionBox {

  private EPRecInvoiceReg ep = EPRecInvoiceReg.getInstance(EPRecInvoiceReg.class);

  public RecInvoiceRegGeneralViewGadget() {
    drawSelf();
  }
  ...
  private class Handler_viewLogAction implements ClickHandler {
    ...
    public void onClick(ClickEvent event) {
      JumpParameters params = new JumpParameters(RecInvoiceRegLogViewPage.START_NODE);
      params.getUrlRef().set(RecInvoiceRegLogViewPage.PN_UUID, entity.getUuid());
      ep.jump(params);
    }
  }
}
