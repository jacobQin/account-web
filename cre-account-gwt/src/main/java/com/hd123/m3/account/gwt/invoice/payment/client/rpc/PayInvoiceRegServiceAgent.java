 ...
 * 
 */
public class PayInvoiceRegServiceAgent {
  private static EPPayInvoiceReg ep = EPPayInvoiceReg.getInstance(EPPayInvoiceReg.class);
  ...
  public static void executeTask(final BProcessContext processCtx, final BOperation operation,
    ...
    PayInvoiceRegService.Locator.getService().executeTask(operation, entity,
