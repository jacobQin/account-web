 ...
 * 
 */
public class PayInvoiceRegGeneralCreateGadget extends RCaptionBox implements HasRActionHandlers,
    RActionHandler {
  private EPPayInvoiceReg ep = EPPayInvoiceReg.getInstance(EPPayInvoiceReg.class);

  public PayInvoiceRegGeneralCreateGadget() {
    drawSelf();
  }
  ...
  private void refreshAccountUnit() {
    ...
    RMsgBox.showConfirm(msg, new ConfirmCallback() {
      ...
      public void onClosed(boolean confirmed) {
        ...
        RActionEvent.fire(PayInvoiceRegGeneralCreateGadget.this, InvoiceRegActionName.REFRESH_LINE);
      }
    });
  }
  ...
  private void refreshInvoiceCode() {
    ...
    PayInvoiceRegService.Locator.getService().getInvoiceCode(entity.getCounterpart().getUuid(),
