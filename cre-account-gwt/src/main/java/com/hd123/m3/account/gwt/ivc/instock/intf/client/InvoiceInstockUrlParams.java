 ...
 * 文件名：	InvoiceInstockUrlParams.java
 * 模块说明：	
 * 修改历史：
 * 2015年12月1日 - lixiaohong - 创建。
 */
package com.hd123.m3.account.gwt.ivc.instock.intf.client;
...
/**
 * GWT模块com.hd123.m3.account.gwt.ivc.instock.InvoiceInstock（发票入库单）的URL参数。
 * 
 * @author lixiaohong
 * @since 1.0
 * 
 */
public class InvoiceInstockUrlParams implements ModuleUrlParams {
  public static final String ENTRY_MODULE = "ivc.instock.InvoiceInstock";
  public static final String ENTRY_FILE = "InvoiceInstock.html";
  ...
  public static interface Flecs extends Base {
    /** 搜索条件的分组ID */
    public static final String GROUP_ID = "Ivc.InvoiceInstock";
    ...
    public static final String FIELD_ISRECEIVE = "isReceive";
    public static final String FIELD_INSTOCKOR = "instockor";
    public static final String FIELD_INVOICE_CODE = "invoiceCode";
    public static final String FIELD_INVOICE_NUNBER = "invoiceNumber";
    public static final String FIELD_INSTOCKDATE = "instockDate";
