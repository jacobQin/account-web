...
public class PStatementLineDef {

  public static CPStatementLine constants = (CPStatementLine) GWT.create(CPStatementLine.class);
  ...
  public static EmbeddedFieldDef freeTotal = new EmbeddedFieldDef("freeTotal", constants.freeTotal());

  public static BigDecimalFieldDef freeTotal_tax = new BigDecimalFieldDef("freeTotal.tax", constants.freeTotal_tax(), false, null, true, null, true, 2);

  public static BigDecimalFieldDef freeTotal_total = new BigDecimalFieldDef("freeTotal.total", constants.freeTotal_total(), false, null, true, null, true, 2);
  ...
  public static OtherFieldDef fromStatement = new OtherFieldDef("fromStatement", constants.fromStatement(), false);

  public static StringFieldDef remark = new StringFieldDef("remark", constants.remark(), true, 0, 128);
  
  public static BigDecimalFieldDef OWED_AMOUNT = new BigDecimalFieldDef("owedAmount", constants.owedAmount(), false, null, true, null, true, 2);
