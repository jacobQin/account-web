 ...
 * 
 */
public class RecDepositGeneralCreateGadget extends RCaptionBox implements HasRActionHandlers,
    RActionHandler {

  private EPRecDeposit ep = EPRecDeposit.getInstance(EPRecDeposit.class);

  public RecDepositGeneralCreateGadget() {
    drawSelf();
  }
  ...
  private Widget drawPaymentInfoPanel() {
    ...
    depositDateField = new RDateBox(DepositMessage.M.receiptDate());
  ...
  private void refreshBanks() {
    ...
    RActionEvent.fire(RecDepositGeneralCreateGadget.this, DepositActionName.CHANGE_REMAINTOTAL);
  }
  ...
  private void doRefreshAccountUnit(BContract contract) {
    ...
    accountUnitUCNBox.setValue(entity.getAccountUnit(), true);
  }
  ...
  private void refreshContract() {
    ...
    RecDepositService.Locator.getService().getContract(entity.getAccountUnit().getUuid(),
