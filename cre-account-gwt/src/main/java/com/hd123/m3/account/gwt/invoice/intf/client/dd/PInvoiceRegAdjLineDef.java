...
public class PInvoiceRegAdjLineDef {

  public static CPInvoiceRegAdjLine constants = (CPInvoiceRegAdjLine) GWT.create(CPInvoiceRegAdjLine.class);
  ...
  public static StringFieldDef adjId = new StringFieldDef("adjId", constants.adjId(), false, 0, 19);
