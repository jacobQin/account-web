...
public class PStatementAdjustDef {

  public static CPStatementAdjust constants = (CPStatementAdjust) GWT.create(CPStatementAdjust.class);
  ...
  public static StringFieldDef counterpart_name = new StringFieldDef("counterpart.name", constants.counterpart_name(), false, 0, 32);
  ...
  public static StringFieldDef settleNo = new StringFieldDef("settleNo", constants.settleNo(), false, 0, 10);
