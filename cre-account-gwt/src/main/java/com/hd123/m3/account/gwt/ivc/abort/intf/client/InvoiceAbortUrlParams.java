 ...
 */
package com.hd123.m3.account.gwt.ivc.abort.intf.client;
...
/**
 * GWT模块com.hd123.m3.account.gwt.ivc.abort.InvoiceAbort（发票作废单）的URL参数。
 * 
 * @author lixiaohong
 * @since 1.7
 * 
 */
public class InvoiceAbortUrlParams implements ModuleUrlParams{
  public static final String ENTRY_MODULE = "ivc.abort.InvoiceAbort";
  public static final String ENTRY_FILE = "InvoiceAbort.html";
  ...
  public static interface Flecs extends Base {
    /** 搜索条件的分组ID */
    public static final String GROUP_ID = "Ivc.InvoiceAbort";
    ...
    public static final String FIELD_ABORTER = "aborter";
