...
public class PaymentUrlParams {
  ...
  public static final String ENTRY_MODULE = "payment.pay.Payment";
  public static final String ENTRY_FILE = "Payment.html";
  ...
  public static interface Flecs {
    ...
    /** 搜索条件的分组ID */
    public static final String GROUP_ID = "Account.Payment";
