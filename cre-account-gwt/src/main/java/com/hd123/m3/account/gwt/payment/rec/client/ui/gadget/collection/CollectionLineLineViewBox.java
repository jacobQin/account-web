...
import com.hd123.m3.account.gwt.payment.rec.client.ui.gadget.AccountLineViewGadget;
 ...
 * 
 */
public class CollectionLineLineViewBox extends RCaptionBox implements RActionHandler,
    HasRActionHandlers {
  ...
  private CollectionLineLineViewGadget collectionLineLineViewGadget;

  public void setBill(BPayment bill) {
    this.bill = bill;
    this.lines = bill.getCollectionLines();
    collectionLineLineViewGadget.setBill(bill);
    refreshTotalCount(0);
    grid.rebuild();
    if (lines.size() > 0) {
      currentRow = 0;
  ...
  public CollectionLineLineViewBox() {
    drawToolbar();
    drawSelf();
  }
  ...
  private void drawSelf() {
    ...
    collectionLineLineViewGadget = new CollectionLineLineViewGadget();
    panel.add(collectionLineLineViewGadget);
  ...
  private Widget drawGrid() {
    ...
    contractCodeCol.setWidth("140px");
  ...
  private void addActionHandler() {
    collectionLineLineViewGadget.addActionHandler(this);
    addActionHandler(collectionLineLineViewGadget);
  }
  ...
  private class GridRowHighlightHandler implements HighlightHandler<Point> {
    ...
    public void onHighlight(HighlightEvent<Point> event) {
      ...
      currentRow = row;
      RActionEvent.fire(CollectionLineLineViewBox.this, ActionName.ACTION_CHANGELINENO,
