...
import com.hd123.m3.account.gwt.payment.rec.client.ui.gadget.LineDepositDefrayalLineEditGadget;
...
public class DepositDefrayalViewGadget extends RCaptionBox {
  ...
  private static final String WIDTH_DETAIL_COL0 = "300px";
  ...
  private Widget drawDetailsTitle() {
    ...
    if (subjectTitle == null)
      subjectTitle = new HTML(PaymentMessages.M.depositPaySubject());
    if (contractTitle == null)
      contractTitle = new HTML(PPaymentLineDepositDef.constants.contract_billNumber());
    if (remainTotalField == null)
      remainTotalField = new HTML(PaymentMessages.M.remainTotal());
    if (totalField == null)
  ...
  private void addDetail(BPaymentDepositDefrayal detail, int index) {
    ...
    contract.setValue(detail.getContract() == null ? null : detail.getContract().getCode());
