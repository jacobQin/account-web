 ...
 * 文件名：	RecInvoiceRegViewPage.java
 * 模块说明：	
 * 修改历史：
...
import com.hd123.m3.account.gwt.invoice.receipt.client.ui.gadget.RecInvoiceRegGeneralViewGadget;
import com.hd123.m3.account.gwt.invoice.receipt.client.ui.gadget.RecInvoiceRegInvoiceViewGadget;
import com.hd123.m3.account.gwt.invoice.receipt.client.ui.gadget.RecInvoiceRegLineViewGadget;
import com.hd123.m3.account.gwt.invoice.receipt.intf.client.RecInvoiceRegUrlParams;
import com.hd123.m3.account.gwt.invoice.receipt.intf.client.RecInvoiceRegUrlParams.View;
 ...
 * 
 */
public class RecInvoiceRegViewPage extends BaseBpmViewPage implements View {

  private static RecInvoiceRegViewPage instance = null;

  public static RecInvoiceRegViewPage getInstance() {
    if (instance == null) {
      instance = new RecInvoiceRegViewPage();
    }
    return instance;
  }

  public RecInvoiceRegViewPage() {
    super();
    drawToolbar();
    drawSelf();
  }
  ...
  private RecInvoiceRegGeneralViewGadget generalViewGadget;
  private RecInvoiceRegLineViewGadget lineViewGadget;
  private RecInvoiceRegInvoiceViewGadget invoiceViewGadget;
  ...
  private void drawSelf() {
    ...
    generalViewGadget = new RecInvoiceRegGeneralViewGadget();
    panel.add(generalViewGadget);

    lineViewGadget = new RecInvoiceRegLineViewGadget();
    lineViewGadget.getCaptionBar().setShowCollapse(true);
    panel.add(lineViewGadget);

    invoiceViewGadget = new RecInvoiceRegInvoiceViewGadget();
  ...
  private void doEdit() {
    JumpParameters params = new JumpParameters(RecInvoiceRegUrlParams.Edit.START_NODE);
    params.getUrlRef().set(RecInvoiceRegUrlParams.Edit.PN_UUID, entity.getUuid());
    getEP().jump(params);
  }
  ...
  private class ProcessDialog extends M3BaseOutgoingDialog {
    ...
    protected void doExcute(BOperation operation, AsyncCallback<Object> callback) {
      ...
      RecInvoiceRegServiceAgent.executeTask(processCtx, operation, entity, false, this);
    }
  }
