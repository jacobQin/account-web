 ...
 * 
 */
public class PayDepositServiceAgent {
  ...
  public static void executeTask(final BProcessContext processCtx, final BOperation operation,
    ...
    PayDepositService.Locator.getService().executeTask(operation, entity, processCtx.getTask(),
        saveBeforeAction, new RBAsyncCallback2<String>() {
          ...
          public void onException(Throwable caught) {
            ...
            String msg = DepositMessage.M.actionFailed(operation.getOutgoingDef().getCaption(),
                ep.getModuleCaption());
